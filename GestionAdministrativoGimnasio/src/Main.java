...
//Creacion instancia Gimnasio
        ...
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador2);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador3);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador4);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador5);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador6);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador7);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador8);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador9);
        GimnasioUTN.getGestionEntrenadores().agregar(entrenador1.getDocumento(), entrenador10);
        ...
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro2);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro3);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro4);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro5);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro6);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro7);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro8);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro9);
        GimnasioUTN.getGestionMiembros().agregar(miembro1.getDocumento(), miembro10);
        ...
        // Añadir personal de mantenimiento al gimnasio
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina1);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina2);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina3);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina4);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina5);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina6);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina7);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina8);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina9);
        GimnasioUTN.getGestionMaquinas().agregar(mantenimiento1.getDocumento(), maquina10);
